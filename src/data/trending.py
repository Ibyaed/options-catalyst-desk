...
class TrendingScanner:
    ...
    def fetch_top_options_trending(self, limit: int = 3) -> list[dict]:
        """
        Pulls top trending equity options plays on Twitter/StockTwits.
        Filters out pure crypto pairs (.X) to keep liquid US optionable stocks.
        """
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                for item in symbols_data:
                    ...
                    # Skip crypto tickers like BTC.X
        ...
        # Fallback to high-volume FinTwit options favorites if API rate limits
        if len(trending) < limit:
            fallbacks = [
